...
namespace XWebDriver
{
    public class OneDriver
    {
        ...
        /// <summary>
        /// Init web driver object instance
        /// </summary>
        /// <param name="theBrowser">Which kind of browser to run</param>
        /// <param name="seconds">Amount of time to wait while element not available immediately</param>
        public OneDriver(Browsers theBrowser, double seconds=0)
        {
        ...
        private void ImplicitlyWait(double seconds)
        {
        ...
        public void WaitForPageLoaded(string partialTitle)
        {
            UI.WebDriverWait _wait = new UI.WebDriverWait(wd, TimeSpan.FromSeconds(10));
            _wait.Until((d) => { return d.Title.ToLower().StartsWith(partialTitle.ToLower()); });
            //to do
        }
        ...
        /// </summary>
        /// <param name="we"></param>
        public void WaitForElementFound(string id)
        {
            UI.WebDriverWait _wait = new UI.WebDriverWait(wd, TimeSpan.FromSeconds(10));
        ...
        public void GoToWindow(string title, bool exactMatch=true)
        {
